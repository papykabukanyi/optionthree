...
def submit_mcaloan():
    if request.method == 'POST':
        ...
        # Map specific fields needed for database
        ...
        send_mca_application_emails(app_id, form_data, pdf_path)
...
def create_mca_pdf(data, files, submission_time, browser, ip_address, unique_id, location, app_id):
    ...
    pdf.set_font("Arial", size=12)
    pdf.cell(130, 10, data.get('company_name', ''), ln=1)
    
    pdf.set_font("Arial", 'B', 12)
    pdf.cell(60, 10, "Time in Business:", ln=0)
    pdf.set_font("Arial", size=12)
    pdf.cell(130, 10, data.get('time_in_business', ''), ln=1)
    
    pdf.set_font("Arial", 'B', 12)
    pdf.cell(60, 10, "Business Industry:", ln=0)
    pdf.set_font("Arial", size=12)
    pdf.cell(130, 10, data.get('business_industry', ''), ln=1)
    
    pdf.set_font("Arial", 'B', 12)
    pdf.cell(60, 10, "Business Type:", ln=0)
    pdf.set_font("Arial", size=12)
    pdf.cell(130, 10, data.get('business_type', ''), ln=1)
    
    pdf.set_font("Arial", 'B', 12)
    pdf.cell(60, 10, "EIN/TAX ID:", ln=0)
    pdf.set_font("Arial", size=12)
    pdf.cell(130, 10, data.get('ein', ''), ln=1)
    
    pdf.set_font("Arial", 'B', 12)
    pdf.cell(60, 10, "Address:", ln=0)
    pdf.set_font("Arial", size=12)
    business_address = f"{data.get('address_line_1', '')}, {data.get('city', '')}, {data.get('state', '')} {data.get('zip_code', '')}"
    pdf.cell(130, 10, business_address, ln=1)
    
    pdf.set_font("Arial", 'B', 12)
    pdf.cell(60, 10, "Company Email:", ln=0)
    pdf.set_font("Arial", size=12)
    pdf.cell(130, 10, data.get('company_email', ''), ln=1)
    
    pdf.set_font("Arial", 'B', 12)
    pdf.cell(60, 10, "Company Phone:", ln=0)
    pdf.set_font("Arial", size=12)
    pdf.cell(130, 10, data.get('company_phone', ''), ln=1)
    
    # Borrower Information
    pdf.ln(5)
    pdf.set_font("Arial", 'B', 14)
    pdf.cell(190, 10, "Borrower Information", ln=True)
    pdf.ln(2)
    ...
    pdf.cell(130, 10, borrower_name, ln=1)
    
    pdf.set_font("Arial", 'B', 12)
    pdf.cell(60, 10, "Date of Birth:", ln=0)
    pdf.set_font("Arial", size=12)
    pdf.cell(130, 10, data.get('borrower_dob', ''), ln=1)
    
    pdf.set_font("Arial", 'B', 12)
    pdf.cell(60, 10, "Percent Ownership:", ln=0)
    pdf.set_font("Arial", size=12)
    pdf.cell(130, 10, data.get('borrower_ownership', ''), ln=1)
    
    pdf.set_font("Arial", 'B', 12)
    pdf.cell(60, 10, "SSN:", ln=0)
    pdf.set_font("Arial", size=12)
    pdf.cell(130, 10, data.get('borrower_ssn', ''), ln=1)
    
    pdf.set_font("Arial", 'B', 12)
    pdf.cell(60, 10, "Email:", ln=0)
    pdf.set_font("Arial", size=12)
    pdf.cell(130, 10, data.get('borrower_email', ''), ln=1)
    
    pdf.set_font("Arial", 'B', 12)
    pdf.cell(60, 10, "Phone:", ln=0)
    pdf.set_font("Arial", size=12)
    pdf.cell(130, 10, data.get('borrower_phone', ''), ln=1)
    
    pdf.set_font("Arial", 'B', 12)
    pdf.cell(60, 10, "Preferred Contact:", ln=0)
    pdf.set_font("Arial", size=12)
    pdf.cell(130, 10, data.get('borrower_preferred_contact', ''), ln=1)
    ...
    if data.get('coapplicant_first_name') or data.get('coapplicant_last_name'):
        ...
        pdf.cell(130, 10, coapplicant_name, ln=1)
        
        pdf.set_font("Arial", 'B', 12)
        pdf.cell(60, 10, "Date of Birth:", ln=0)
        pdf.set_font("Arial", size=12)
        pdf.cell(130, 10, data.get('coapplicant_dob', ''), ln=1)
        
        pdf.set_font("Arial", 'B', 12)
        pdf.cell(60, 10, "Percent Ownership:", ln=0)
        pdf.set_font("Arial", size=12)
        pdf.cell(130, 10, data.get('coapplicant_ownership', ''), ln=1)
        
        pdf.set_font("Arial", 'B', 12)
        pdf.cell(60, 10, "SSN:", ln=0)
        pdf.set_font("Arial", size=12)
        pdf.cell(130, 10, data.get('coapplicant_ssn', ''), ln=1)
        
        pdf.set_font("Arial", 'B', 12)
        pdf.cell(60, 10, "Email:", ln=0)
        pdf.set_font("Arial", size=12)
        pdf.cell(130, 10, data.get('coapplicant_email', ''), ln=1)
        
        pdf.set_font("Arial", 'B', 12)
        pdf.cell(60, 10, "Phone:", ln=0)
        pdf.set_font("Arial", size=12)
        pdf.cell(130, 10, data.get('coapplicant_phone', ''), ln=1)
        
        pdf.set_font("Arial", 'B', 12)
        pdf.cell(60, 10, "Preferred Contact:", ln=0)
        pdf.set_font("Arial", size=12)
        pdf.cell(130, 10, data.get('coapplicant_preferred_contact', ''), ln=1)
        ...
        pdf.cell(130, 10, coapplicant_address, ln=1)
    ...
    pdf.set_font("Arial", size=12)
    pdf.cell(130, 10, data.get('amount_requested', ''), ln=1)
    
    pdf.set_font("Arial", 'B', 12)
    pdf.cell(60, 10, "Term Length:", ln=0)
    pdf.set_font("Arial", size=12)
    pdf.cell(130, 10, data.get('term_length', ''), ln=1)
    
    pdf.set_font("Arial", 'B', 12)
    pdf.cell(60, 10, "Credit Score Range:", ln=0)
    pdf.set_font("Arial", size=12)
    pdf.cell(130, 10, data.get('credit_score_range', ''), ln=1)
    ...
    if 'signature' in data:
        try:
            ...
            pdf.ln(5)
            pdf.set_font("Arial", 'B', 14)
            pdf.cell(190, 10, "Signature", ln=True)
            pdf.ln(2)
