...
#     pdf.ln(30)  # Reduced space after logos

#     # Business Information
#     pdf.set_font("Arial", 'B', 8)
#     pdf.cell(0, 8, txt="Business Information", ln=True)  # Reduced line height
...
#     pdf.ln(4)  # Small space before next section
...
#     os.remove(pdf_filename)  # Remove the generated PDF file

#     return render_template('congratulation.html')  # Render confirmation page
...
#     sender_email = 'papykabukanyi@gmail.com'
#     sender_password = 'snwucxupdkadlfef'
#     receiver_email = 'papykabukanyi@gmail.com'
